        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    AddAccountDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Members_BankAccounts_BankAccountId",
            ...
            migrationBuilder.CreateTable(
                name: "BankAccountBanker",
                columns: table => new
                {
                    BankAccountsBankAccountId = table.Column<int>(type: "int", nullable: false),
                    BankersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BankAccountBanker", x => new { x.BankAccountsBankAccountId, x.BankersId });
                    table.ForeignKey(
                        name: "FK_BankAccountBanker_BankAccounts_BankAccountsBankAccountId",
                        column: x => x.BankAccountsBankAccountId,
                        principalTable: "BankAccounts",
                        principalColumn: "BankAccountId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BankAccountBanker_Bankers_BankersId",
                        column: x => x.BankersId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BankAccountBanker_BankersId",
                table: "BankAccountBanker",
                column: "BankersId");

            migrationBuilder.CreateIndex(
                name: "IX_Members_BankAccountId",
                table: "Members",
